...
//  Animate Course
//
//  Created by Nkosi Yafeu on 6/2/22.
//
...
struct SignInView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            Text("Sign In")
                .customFont(.headline)
            Text("Access to 240+ hours of content. Learn design and code, by building real world apps with Machine Learning, React and Swift.")
                .customFont(.headline)
